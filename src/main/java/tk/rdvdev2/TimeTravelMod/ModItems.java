...
public class ModItems {
    ...
    public static final RegistryObject<Item> TIME_CRYSTAL = ITEMS.register("timecrystal", () -> new Item(new Item.Properties().group(TAB_TTM)));
    public static final RegistryObject<Item> CONTROLLER_CIRCUIT = ITEMS.register("controllercircuit", () -> new Item(new Item.Properties().group(TAB_TTM)));
    public static final RegistryObject<Item> HEAVY_INGOT = ITEMS.register("heavyingot", () -> new Item(new Item.Properties().group(TAB_TTM)));
    ...
    public static final RegistryObject<Item> COMMUNICATIONS_CIRCUIT = ITEMS.register("communicationscircuit", () -> new Item(new Item.Properties().group(TAB_TTM)));
