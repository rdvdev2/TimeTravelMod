...
public class EngineerBookScreen extends Screen {
    ...
    public EngineerBookScreen(Collection<com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine> timeMachines) {
        super(new StringTextComponent(""));

        timeMachineData = new ArrayList<>(timeMachines.size());

        Iterator<com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine> iterator = timeMachines.iterator();
        int i = 0;
        while (iterator.hasNext()) {
            com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine tm = iterator.next();
