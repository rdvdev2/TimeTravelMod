...
public class DimensionTpPKT {
    ...
    private com.rdvdev2.TimeTravelMod.common.world.dimension.TimeLine tl;
    private TimeMachine tm;
    private BlockPos pos;
    private Direction side;
    private Set<UUID> additionalEntities;

    public DimensionTpPKT(com.rdvdev2.TimeTravelMod.common.world.dimension.TimeLine tl, TimeMachine tm, BlockPos pos, Direction side, UUID... additionalEntities) {
        this();
        this.tl = tl;
    ...
    public static DimensionTpPKT decode(PacketBuffer buf) {
        ...
        pkt.tl = (com.rdvdev2.TimeTravelMod.common.world.dimension.TimeLine) buf.readRegistryIdSafe(TimeLine.class);
    ...
    public static void applyCorruption(TimeMachine tm, DimensionType origDim, DimensionType destDim, MinecraftServer server) {
        ...
        for (TimeLine timeLine: ModRegistries.TIME_LINES) {
            com.rdvdev2.TimeTravelMod.common.world.dimension.TimeLine current = (com.rdvdev2.TimeTravelMod.common.world.dimension.TimeLine) timeLine;
