...
public class TimeMachineHookRunner implements com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine {
    ...
    @Override
    public com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine setRegistryName(String name) {
        return tm.setRegistryName(name);
    }

    @Override
    public com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine setRegistryName(String modID, String name) {
        return tm.setRegistryName(modID, name);
    }

    @Override
    public com.rdvdev2.TimeTravelMod.api.timemachine.TimeMachine setRegistryName(ResourceLocation name) {
        return tm.setRegistryName(name);
    }
